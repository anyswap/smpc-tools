...
export function useRpcContract(
  ...
  return useMemo(() => {
    ...
    const web3Fn = new Web3(
      new Web3.providers.HttpProvider(config.getCurChainInfo(chainId).nodeRpc)
    );
    try {
...
export function useV1FactoryContract(): Contract | null {
  return useContract(
    config.v1FactoryToken ? config.v1FactoryToken : undefined,
    V1_FACTORY_ABI,
    false
  );
}
...
export function useVeMULTIContract(
  veToken?: any,
  withSignerIfPossible?: boolean
): Contract | null {
  return useContract(
...
export function useVeMULTIRewardContract(
  veToken?: any,
  withSignerIfPossible?: boolean
): Contract | null {
  return useContract(
...
export function useSwapBTCContract(
  tokenAddress?: string,
  withSignerIfPossible?: boolean
): Contract | null {
...
export function useSwapETHContract(
  tokenAddress?: string,
  withSignerIfPossible?: boolean
): Contract | null {
...
export function useSwapMultiContract(
  address: string | undefined,
  withSignerIfPossible?: boolean
): Contract | null {
